...
public class ArrayEx1 {
	...
	public void ex1() {
		...
		// 배열 선언
		int[] arr; // int 자료형 변수를 묶어서 다루는 배열 arr 선언
		// int[]은 참조형
		...
		// * 배열 다루기 *
		System.out.println("arr : " + arr); // arr : [I@6f2b958e -> 주소값 출력(0x0300) 
...
//		menuArray[4] = "닭갈비";
	...
	public void ex5() {
		...
		String[] menus = {"김밥","참치김밥","치즈김밥","불고기김밥","라볶이"};
		int[] prices = {3000, 4000, 3500, 4000, 6000};
