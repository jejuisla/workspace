...
/* 객체란?
 * 
 * - 현실(object) : 속성(data)과 기능(method)을 가지고 있는 식별 가능한 것
 * 
 * - Java(instance) : 클래스에 작성된 내용을 토대로
...
public class BasicRun {
	public static void main(String[] args) {
		...
		// 클래스 == 설계도 == 사용자 정의 자료형
		// Nation n1 : Nation 객체 참조 변수 n1을 선언(주소 저장), 기본자료형 8개 아닌 자료형들은 다 참조형
		// new Nation() : Nation 클래스를 이용해서 Heap 영역에 Nation 객체를 생성(메모리 할당)
		//				  -> 할당된 메모리의 시작 주소가 반환됨
		
		// Nation n1 = new Nation() : Nation 참조 변수 n1에 Heap에 새로 생성된 Nation 객체의 주소를 대입
		...
		// n1.job = "국정원 비밀요원";
		// The field Nation.job is not visible -> job 변수 안보임
