...
public class User {
	...
	public User(String name) {
		...
		// - 현재 객체가 가지고 있는 필드, 메서드를 명확하게 지칭할 때 사용
		this.name = name; 
		// 현재 객체의 name필드에 전달받은 name 값을 저장	
	}
	
	
	// 오버로딩(OverLoading)
	// - 한 클래스 내부에
	//   동일한 이름이 메서드, 생성자를 여러개 작성하는 기법
	...
	public User(int age, String name) { // 매개변수 순서가 다름
		this.name = name;
		this.age = age;
	}
