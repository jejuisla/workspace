...
<body>
  <h1>EL을 이용해서 파라미터 출력</h1>
  <h4>${param.inputDate}</h4>

  <hr>
  <h1>EL을 이용해서 세팅된 속성(Attribute)값 출력</h1>
  <ul>
    <li>[작성법] : \${key}</li>
    <li>기본 자료형 : ${score}</li>
    ...
    <li>
      ...
      <ul>
        ...
        <%-- ${key.필드명} : 자동으로 getter 호출하여 값을 얻어옴 --%>
        <li>title : ${b1.title}</li>
        <li>writter : ${b1.writter}</li>
