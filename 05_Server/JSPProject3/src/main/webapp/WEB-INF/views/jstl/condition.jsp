...
<body>
  ...
  <pre>
    - 조건식이 true이며 수행 + 화면에 출력
    - 별도의 else 구문이 없음
    - 속성은 test만 존재

    ** test 속성 값 작성시 유의사항
    1) 속성 값은 무조건 EL구문으로 작성 해야됨
        test="\${key==123}"
  ...
  <pre>
    ...
    ex) http://localhost/jstl/condition?val=88

    쿼리스트링(?val=88) 부분을 변경하면서 테스트
  </pre>
  <%-- 파라미터에 val이 존재한다면 --%>
