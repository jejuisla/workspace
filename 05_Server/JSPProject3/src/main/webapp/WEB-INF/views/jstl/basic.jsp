...
<body>
  <h1>1. 변수선언(=속성 추가) (c:set 태그)</h1>
  <pre>
    - 변수 선언(setAttribute == 속성 추가)를 위한 태그
    - 작성 가능한 속성
      1) var : 변수명 (== 속성 key)
  ...
  <hr>
  <h1>1. 변수제거(=속성 제거) (c:remove 태그)</h1>
  <pre>
  ...
  <pre>
    ...
    - 단, escapeXml 속성 값에 따라 html 태그 해석 여부가 결정됨
    true : 해석 X (기본 값)
    false : 해석 O 
  </pre>
