...
public class EditBoardController {
	...
	private final BoardService boardService; // 게시글 상세 조회 호출용
	...
	public String updateBoard(@PathVariable("boardCode") int boardCode, @PathVariable("boardNo") int boardNo, Model model) {
		
		// 게시글 수정 화면에는 수정하려는
		// 수정하려는 게시글의 상세 내용이 작성되어 있어야 함
		// -> 게시글 상세 조회 진행
	...
	public String updateBoard(@PathVariable("boardCode") int boardCode, @PathVariable("boardNo") int boardNo,
								Board board, String querystring, String deleteOrder, @RequestParam("images") List<MultipartFile> images, RedirectAttributes ra) throws IllegalStateException, IOException { 
