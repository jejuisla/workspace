...
public class OpenApiController {
	...
	public String ex2(Model model, @RequestParam(value="regionName", required = false, defaultValue = "서울") String regionName ) throws IOException, JSONException{
		// 인증키
		final String serviceKey = "xjr91ulq%2Fm7d%2FLwUWEkDAKl7Bo5OdLa7q9Db1PVhqH3%2FLFLxcFamNlIVQIf1QXAhFda32vIxn0abtP%2BdC%2B4PMQ%3D%3D";
	   ...
	   // 현재 시간 얻어와 baseDate, baseTime가공
	      ...
	      StringBuilder urlBuilder = new StringBuilder("http://apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getUltraSrtFcst"); /*URL*/
	        ...
	        System.out.println("Response code: " + conn.getResponseCode()); // HTTP 응답 상태 코드 (200번대 성공을 의미)
	        BufferedReader rd;
...
//	        				JSON 데이터를 Java 객체로 변환하는 객체
	        ...
	        // item 변수에 담긴 JSON 데이터 하나하나를 Map으로 변경한 후
	        // List에 추가
