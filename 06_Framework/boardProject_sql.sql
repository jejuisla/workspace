...
-- 계정 생성
CREATE USER spring_kjm IDENTIFIED BY spring1234;

-- 권한 부여
GRANT CONNECT, RESOURCE, CREATE VIEW TO spring_kjm;

-- 객체 생성 공간 할당
ALTER USER spring_kjm DEFAULT TABLESPACE "A230724"
...
-- VARCHAR2(10) : 10 BYTE(BYTE 단위), 최대 4000 BYTE
-- NVARCHAR2(10) : 10 글자(UNICODE), 최대 4000 BYTE
...
COMMENT ON COLUMN "MEMBER"."MEMBER_TELL" IS '전화번호(-없음)';
...
UPDATE "MEMBER" SET
"MEMBER_PW" = '$2a$10$Yvp1kTZ1hjFQqd0dT4W6w.R.lPLL6kfgQMNXeG81Q2oxx4WhxPQBa'
WHERE MEMBER_NO = 1;
...
VALUES(SEQ_MEMBER_NO.NEXTVAL,MEMBER_EMAIL, MEMBER_TEL)
