...
DEPT_TITLE NOT NULL; -- NOT NULL (NULL 허용 X)
--			NULL (NULL 허용)
---------------------------
...
ALTER TABLE DEPT_COPY MODIFY
DEPT_ID CONSTRAINT SYS_C0014065 NULL; -- DEPT_ID NOT NULL 제거

ALTER TABLE DEPT_COPY MODIFY
LOCATION_ID CONSTRAINT SYS_C0014066 NULL; -- LOCATION_ID NOT NULL 제거

ALTER TABLE DEPT_COPY MODIFY
DEPT_TITLE CONSTRAINT SYS_C0014114 NULL; -- DEPT_TITLE NOT NULL 제거
...
CREATE TABLE BOARD(
	...
	BOARD_DEL_FL CHAR(1) DEFAULT 'N' NOT NULL CHECK(BOARD_DEL_FL IN('N','Y')),
