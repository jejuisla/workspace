...
-- 계정 생성
CREATE USER a230830_kjm IDENTIFIED BY "qwer1234";
--> 생성 후 DB접속 방법 추가
--> 접속 권한 없음

/* 접속 권한 부여(GRANT) */
GRANT CREATE SESSION TO a230830_kjm;
...
-- [관리자 계정]
-- 테이블 생성 권한, TABLESACE 할당
GRANT CREATE TABLE TO a230830_kjm;

ALTER USER a230830_kjm DEFAULT TABLESPACE "A230724"
...
GRANT CONNECT, RESOURCE, CREATE VIEW TO a230830_kjm;


-- 테스트 사용자 계정 접속 권한 회수 테스트
REVOKE CONNECT FROM a230830_kjm;
