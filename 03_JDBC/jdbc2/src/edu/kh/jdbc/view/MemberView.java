...
public class MemberView {
	...
	private void insertMember() {
		...
		// DML(INSERT,UPDATE,DELELTE) 결과는 성공한 행의 수(int)로 반환
	...
	private void updateMember() {
		...
		System.out.print("수정할 휴대폰 번호(-없음) : ");
		String tel = sc.next();
		sc.nextLine(); 
...
//		member.setMemberPw(pw);
		...
		int result = service.deleteMember(member); // 삭제 서비스 호출 -> 결과는 int로 반환
	...
	private void updatePw() {
		...
		Member member = new Member(email,pw,newPw);
