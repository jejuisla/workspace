...
const InputName = () => {
  ...
  return (
    /* JSX = JavaScript Xml : JS 내부에서 마크업 언어 작성 */
    <div>
      <p>이름을 입력하세요</p>
      <input
        type="text"
...
const TodoList = () => {
  ...
  return (
    <>
      ...
      {/* 배열.map( (배열 요소, 인덱스) => {retrun 값;}) 
        - 기존 배열의 요소를 순차 접근(향상된 for문 느낌)
        - 매개변수 중 배열요소에 기본 배열의 요소가 하나씩 대입

        - return 되는 값을 모아서 새로운 배열을 반환
      */}
      <ul>
