...
class ComponentEx extends Component {
  ...
  constructor(props) {
    ...
    // 만들어지는 컴포넌트에 count:0 이라는 상태 추가
    // 0으로 초기화
    this.state = { count: 0 };
  }

  // 이벤트 : 행동, 동작 (clean, keyup, mouseover 등)
  // 이벤트 리스너 : 이벤트 감지 (onclick, onkeyup )(on이 붙어 있는 것)
  ...
  // render() 함수 : // return 되는 html형식의 코드(jsx, js + xml)를 화면에 출력하는 함수
